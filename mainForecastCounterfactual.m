...
p = 4;   
data = xlsread('Final Dataset Forecast SSP Counterfactual.xlsx','hard_constraintapp1'); % load US data
[soft dat] = xlsread('Final Dataset Forecast SSP Counterfactual.xlsx',['Soft_constraint Counterfactual']); % load US data
...
figure
subplot(2,2,[1:2])
plotx2r([repmat(data(end-lengthfor:end,2),1,3);[base_forecast(:,2) base_forecast16(:,2)  base_forecast84(:,2)] ],1:68)
hold on
plotx2n([repmat(data(end-lengthfor:end,2),1,3);[base_forecastunc(:,2) base_forecastunc16(:,2)  base_forecastunc84(:,2)]  ],1:68)
hold on
plot(1:T2,data(end-lengthfor:end,2),'k','LineWidth',3)
xticks([1 8 13 18 23 28 33 38 43 48 53 58 63 68])
xticklabels({'1993','1990','1995','2000','2005','2010','2015','2020','2025','2030','2035','2040','2045','2050'})
xlim([1 68])
grid on
ylabel('Levels')
...
subplot(2,2,[3,4])
plotx2r([repmat(data(end-lengthfor:end,3),1,3);[base_forecast(:,3) base_forecast16(:,3)  base_forecast84(:,3)] ],1:68)
hold on
plotx2n([repmat(data(end-lengthfor:end,3),1,3);[base_forecastunc(:,3) base_forecastunc16(:,3)  base_forecastunc84(:,3)]  ],1:68)
hold on
...
xticklabels({'2015','2020','2025','2030','2035','2040','2045','2050'})
xlim([1 35])
ylabel('Difference')
